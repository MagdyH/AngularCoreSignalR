...
namespace PersonalDiaryToDo.Migrations
{
    ...
    [Migration("20190824141437_rename-tables")]
            ...
            modelBuilder.Entity("PersonalDiaryToDo.Models.UserDiary", b =>
                {
                    ...
                    b.HasData(
                        new { UserDiaryId = 1, DiaryDataTime = new DateTime(2019, 8, 24, 16, 14, 35, 968, DateTimeKind.Local), DiaryImage = "", DiaryText = "Go To Party", InsertionDate = new DateTime(2019, 8, 24, 16, 14, 35, 982, DateTimeKind.Local), UserId = 1 }
                    );
                });
